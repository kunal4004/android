...
class ProductSubstitutionRepositoryTest {
    ...
    fun test_emptyResponse_fetchInventory() = runTest {
        Mockito.`when`(substitutionApiHelper.fetchInventoryForSubstitution(STORE_ID, SKU_ID))
    ...
    fun test_emptyResponse_addSubstitutions() = runTest {
        ...
        Mockito.`when`(substitutionApiHelper.addSubstitution(addSubstitutionRequest))
