...
class GetShoppingList(private val responseDelegate: AsyncAPIResponse.ResponseDelegate<ShoppingListsResponse>?) : HttpAsyncTask<String, String, ShoppingListsResponse>() {

    private var mException: String? = null

    override fun httpDoInBackground(vararg params: String?): ShoppingListsResponse {
        return WoolworthsApplication.getInstance().api.shoppingLists
    }
