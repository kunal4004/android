...
public class MockWfsApiInterceptor extends NetworkConfig implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (apiResponseDao.id != null && !MockOneAppService.INSTANCE.getForceNetworkUpdate()) {
        ...
        MockOneAppService.INSTANCE.setForceNetworkUpdate(false);
