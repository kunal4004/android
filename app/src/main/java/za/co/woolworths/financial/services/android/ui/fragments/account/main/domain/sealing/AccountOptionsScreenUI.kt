...
sealed class AccountOptionsScreenUI {
    data class ViewTreatmentPlan(val isVisible: Boolean = false) : AccountOptionsScreenUI()
    data class SetUpAPaymentPlan(val isVisible: Boolean = false) : AccountOptionsScreenUI()
    data class PaymentOptionsScreenUI(val isVisible: Boolean = false) : AccountOptionsScreenUI()
    data class BalanceProtectionInsurance(val status : BpiInsuranceApplicationStatusType ,val leadGen: BpiInsuranceApplication? = null) : AccountOptionsScreenUI()
