...
public class SendEStatement extends HttpAsyncTask<String, String, StatementResponse> {
	...
	public SendEStatement(Context context, Statement statement, OnEventListener callback) {
