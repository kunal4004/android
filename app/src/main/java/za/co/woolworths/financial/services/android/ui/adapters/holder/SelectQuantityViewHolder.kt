...
class SelectQuantityViewHolder(parent: ViewGroup) : ProductListingViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.select_your_quantity_row, parent, false)) {
