...
public class WfsApi {
    ...
    public OfferActive getActiveOffer(String productOfferingId){
        // Session token hardcoded for test purpose
        return mApiInterface.getActiveOffer(getApiId(), getSha1Password(), getDeviceManufacturer(), getDeviceModel(), getNetworkCarrier(), getOS(), getOsVersion(), getSession(), productOfferingId);
    }
