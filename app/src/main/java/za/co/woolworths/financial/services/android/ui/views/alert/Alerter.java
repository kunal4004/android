...
public final class Alerter {
    ...
    private za.co.woolworths.financial.services.android.ui.views.alert.Alert alert;
    ...
    public static Alerter create(@NonNull final Activity activity) {
        ...
        alerter.setAlert(new za.co.woolworths.financial.services.android.ui.views.alert.Alert(activity));
    ...
    private static void clearCurrent(@NonNull final Activity activity) {
        ...
        try {
            ...
            for (int i = 0; i < decorView.getChildCount(); i++) {
                final za.co.woolworths.financial.services.android.ui.views.alert.Alert childView = decorView.getChildAt(i) instanceof za.co.woolworths.financial.services.android.ui.views.alert.Alert ? (za.co.woolworths.financial.services.android.ui.views.alert.Alert) decorView.getChildAt(i) : null;
    ...
    @NonNull
    private static Runnable getRemoveViewRunnable(final za.co.woolworths.financial.services.android.ui.views.alert.Alert childView) {
        return new Runnable() {
            @Override
            public void run() {
                try {
     ...
     */
    public za.co.woolworths.financial.services.android.ui.views.alert.Alert show() {
     ...
     */
    private za.co.woolworths.financial.services.android.ui.views.alert.Alert getAlert() {
        return alert;
    }
     ...
     */
    private void setAlert(final za.co.woolworths.financial.services.android.ui.views.alert.Alert alert) {
        this.alert = alert;
    }
