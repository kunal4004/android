...
class WrewardsBottomSheetFragment : WBottomSheetDialogFragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val alreadyHaveText: String = context?.getString(R.string.already_have_a_wrewards_card).toString()
        val addItNowText: String = context?.getString(R.string.add_it_now).toString()

        val wordSpan: Spannable = SpannableString(alreadyHaveText
            .plus(" ")
            .plus(addItNowText))
