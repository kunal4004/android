...
class SuccessTickView : View {
    ...
    private val CONST_RADIUS = dip2px(2.0f)
    private val CONST_RECT_WEIGHT = dip2px(4f)
    private val CONST_LEFT_RECT_W = dip2px(18f) // tick left side length
    private val CONST_RIGHT_RECT_W = dip2px(36f)
    private val MIN_LEFT_RECT_W = dip2px(4.0f)
    private val MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + dip2px(10.0f)
    ...
    fun startTickAnim() {
        ...
        tickAnim.duration = 250
        tickAnim.startOffset = 50
