 ...
 */
public class WObservableRecyclerView extends RecyclerView implements Scrollable {
    ...
    public WObservableRecyclerView(Context context) {
        super(context);
        init();
    }

    public WObservableRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WObservableRecyclerView(Context context, AttributeSet attrs, int defStyle) {
