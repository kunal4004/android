...
private val STATE_KEY = FloatingActionButtonBadgeCounter::class.java.name + ".STATE"
 ...
 */
open class FloatingActionButtonBadgeCounter @JvmOverloads constructor(
        context: Context,
        attrs: AttributeSet? = null,
        defStyleAttr: Int = R.attr.floatingActionButtonStyle
) : FloatingActionButton(context, attrs, defStyleAttr) {

    private val animationProperty = object : Property<FloatingActionButtonBadgeCounter, Float>(Float::class.java, "animation") {

        override fun set(FloatingActionButtonBadgeCounter: FloatingActionButtonBadgeCounter, value: Float) {
            animationFactor = value
            postInvalidateOnAnimation()
        }

        override fun get(FloatingActionButtonBadgeCounter: FloatingActionButtonBadgeCounter): Float {
            return 0f
        }
    }
    ...
    private val textPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        textSize = this@FloatingActionButtonBadgeCounter.textSize
    ...
    init {
        val styledAttributes = context.theme.obtainStyledAttributes(
                attrs, R.styleable.FloatingActionButtonBadgeCounter, 0, 0
        )
