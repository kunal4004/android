...
public class WBottomNavigationView extends BottomNavigationView {
	// used for animation
	...
	// detect menu_navigation tab changes when the user clicking on menu_navigation item
	private static boolean isNavigationItemClicking = false;

	public WBottomNavigationView(Context context) {
		super(context);
//        init();
	}

	public WBottomNavigationView(Context context, AttributeSet attrs) {
		super(context, attrs);
//        init();
	}

	public WBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
	...
	/**
	 * enable the shifting mode for menu_navigation
	 *
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
	...
	public void setupWithViewPager(@Nullable final ViewPager viewPager, boolean smoothScroll) {
		...
		// Now we'll add a menu_navigation item selected listener to set ViewPager's current item
	 ...
	 * necessary calls back to the provided {@link WBottomNavigationView} so that the tab position is
	 * kept in sync.
	 * <p>
	...
	private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
		private final WeakReference<WBottomNavigationView> mBnveRef;

		public BottomNavigationViewExOnPageChangeListener(WBottomNavigationView bnve) {
		...
		public void onPageSelected(final int position) {
			final WBottomNavigationView bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
	...
	private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
		...
		MyOnNavigationItemSelectedListener(ViewPager viewPager, WBottomNavigationView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
