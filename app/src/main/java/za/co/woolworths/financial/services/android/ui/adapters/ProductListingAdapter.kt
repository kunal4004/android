...
class ProductListingAdapter(private val navigator: IProductListing?, private val mProductListItems: List<ProductList>?) : RecyclerView.Adapter<RecyclerViewViewHolder>() {
