...
public class WViewFinderView extends View implements IViewFinder {
    ...
    public WViewFinderView(Context context) {
        super(context);
        init();
    }

    public WViewFinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
