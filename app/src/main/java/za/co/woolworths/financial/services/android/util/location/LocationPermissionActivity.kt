...
import za.co.woolworths.financial.services.android.util.location.LocationProvider.Companion.EXTRA_LOCATION_PERMISSION_RATIONALE
...
class LocationPermissionActivity  : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private fun onPermissionDenied() {
        Logger.logDebug("LocationPermissionActivity: onPermissionDenied()")
        broadcastPermissionEvent(LocationPermissionEvent.LOCATION_PERMISSION_NOT_GRANTED)
    }
