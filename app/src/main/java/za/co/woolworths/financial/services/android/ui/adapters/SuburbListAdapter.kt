                ...
                suburbFilterList[position].let {
                    ...
                    when (deliveryType) {
                        DeliveryType.DELIVERY -> {
                            ...
                            name.setTextColor(if (!it.suburbDeliverable) bindColor(R.color.black_50) else bindColor(R.color.black63))
                        ...
                        DeliveryType.STORE_PICKUP -> {
                            ...
                            name.setTextColor(if (!it.storeDeliverable) bindColor(R.color.black_50) else bindColor(R.color.black63))
