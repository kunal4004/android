...
class ActivateVirtualTempCardFragment :
    ...
    private fun setupView(
        ...
        if (activateVTC?.isTemporaryCardEnabled == true) {
            ...
            binding.storeCardImageView.contentDescription = getString(R.string.active_vtsc_card_image_on_overlay)
            ...
            binding.accountHolderNameTextView.contentDescription = getString(R.string.active_vtsc_card_image_embossed_name_label_text_on_overlay)
        } else {
