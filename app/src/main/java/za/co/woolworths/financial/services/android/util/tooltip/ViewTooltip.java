...
public class ViewTooltip {
	...
	public ViewTooltip customView(LetterSpacingTextView customView) {
		this.tooltip_view.setCustomView(customView);
		return this;
	}

	public ViewTooltip customView(int viewId) {
		this.tooltip_view.setCustomView((LetterSpacingTextView) ((Activity) view.getContext()).findViewById(viewId));
		return this;
	}
	...
	public ViewTooltip text(String text) {
		this.tooltip_view.setText(text.toUpperCase().trim());
		return this;
	}
	...
	public static class TooltipView extends FrameLayout {
		...
		protected LetterSpacingTextView childView;
		...
		public void setCustomView(LetterSpacingTextView customView) {
