...
public class SuccessTickView extends View {
    ...
    private final float CONST_RADIUS = dip2px(2.0f);
    private final float CONST_RECT_WEIGHT = dip2px(4);
    private final float CONST_LEFT_RECT_W = dip2px(18); // tick left side length
    private final float CONST_RIGHT_RECT_W = dip2px(36);
    private final float MIN_LEFT_RECT_W = dip2px(4.0f);
    private final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + dip2px(10.0f);
    ...
    public void startTickAnim () {
        ...
        tickAnim.setDuration(200);
        tickAnim.setStartOffset(150);
