...
public class ProductSearchAdapter extends RecyclerView.Adapter<ProductSearchAdapter.SimpleViewHolder> {
	...
	public ProductSearchAdapter(Activity mContext, List<ProductList> mProductList,
