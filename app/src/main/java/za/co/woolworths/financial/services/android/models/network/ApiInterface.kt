...
interface ApiInterface {
   ...
   suspend fun getSavedAddress(
    ...
    suspend fun removeCartItem(
        ...
        @Header("sessionToken") sessionToken: String,
        @Header("deviceIdentityToken") deviceIdentityToken: String,
        @Query("commerceId") commerceId: String): retrofit2.Response<ShoppingCartResponse>
    ...
    suspend fun getShoppingList(
            @Header("sessionToken") sessionToken: String,
            @Header("deviceIdentityToken") deviceIdentityToken: String): retrofit2.Response<ShoppingListsResponse>
    ...
    suspend fun createNewList(
            @Header("sessionToken") sessionToken: String,
            @Header("deviceIdentityToken") deviceIdentityToken: String,
            @Body name: CreateList): retrofit2.Response<ShoppingListsResponse>
    ...
    suspend fun validatePlace(
        ...
        @Header("sessionToken") sessionToken: String,
        @Header("deviceIdentityToken") deviceIdentityToken: String,
        @Query("placeId") placeId: String): retrofit2.Response<ValidateLocationResponse>
