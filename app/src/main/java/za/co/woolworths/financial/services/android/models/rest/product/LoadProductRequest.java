...
public class LoadProductRequest extends HttpAsyncTask<String, String, ProductView> {
	...
	public LoadProductRequest(Context context, LoadProduct loadProduct, OnEventListener callback) {
	...
	protected ProductView httpDoInBackground(String... params) {
		return mWoolworthsApp.getApi().productViewRequest(mProductRequestModel);
	}
