...
interface IMobileConfigsContentDataSource {
    suspend fun fetchContactUsConfigFromMobileConfig(): Flow<CoreDataSource.IOTaskResult<MobileConfigRemoteContentModel>>
}
...
class MobileConfigsContentDataSource @Inject constructor(private val service: WfsApiService) :
    ...
    override suspend fun fetchContactUsConfigFromMobileConfig(): Flow<IOTaskResult<MobileConfigRemoteContentModel>> =
