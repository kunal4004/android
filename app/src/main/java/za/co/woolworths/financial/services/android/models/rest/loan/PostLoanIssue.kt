...
class PostLoanIssue(private val mIssueLoanRequest: IssueLoanRequest, private val mCallBack: OnEventListener<IssueLoanResponse>?)
    ...
    override fun httpDoInBackground(vararg params: String): IssueLoanResponse {
        return WoolworthsApplication.getInstance().api.issueLoan(mIssueLoanRequest)
    }
