...
/**
 * Created by dimitrij on 06/06/2017.
 */
...
public class FusedLocationSingleton implements GoogleApiClient.ConnectionCallbacks,
	...
	private synchronized void buildGoogleApiClient() {
		...
		mGoogleApiClient = new GoogleApiClient.Builder(WoolworthsApplication.getAppContext())
	...
	public void onLocationChanged(Location location) {
		if (location != null) {
			...
			LocalBroadcastManager.getInstance(WoolworthsApplication.getAppContext()).sendBroadcast(intent);
		}
	}
