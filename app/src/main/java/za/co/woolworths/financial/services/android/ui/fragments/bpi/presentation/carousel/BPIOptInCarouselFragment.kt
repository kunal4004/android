...
class BPIOptInCarouselFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as? BalanceProtectionInsuranceActivity)?.changeActionBarUI(android.R.color.transparent)
        ...
        val insuranceLeadGenCarouselAdapter =
            object : FragmentStateAdapter(this@BPIOptInCarouselFragment) {
                override fun createFragment(position: Int): Fragment =
                    InsuranceLeadGenCarouselItemFragment.newInstance(Pair(InsuranceLeadGenCarouselItemFragment::class.java.simpleName,carouselList?.get(position) ?: InsuranceLeadCarousel.SLIDE_1 ))
