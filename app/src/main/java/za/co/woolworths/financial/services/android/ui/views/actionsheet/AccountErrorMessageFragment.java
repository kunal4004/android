...
public class AccountErrorMessageFragment extends ActionSheetDialogFragment implements View.OnClickListener {

    public static AccountErrorMessageFragment newInstance(String responseDesc) {
        AccountErrorMessageFragment singleButtonDialogFragment = new AccountErrorMessageFragment();
    ...
    public static AccountErrorMessageFragment newInstance(String responseDesc, String buttonText) {
        AccountErrorMessageFragment singleButtonDialogFragment = new AccountErrorMessageFragment();
        Bundle bundle = new Bundle();
        bundle.putString("responseDesc", responseDesc);
