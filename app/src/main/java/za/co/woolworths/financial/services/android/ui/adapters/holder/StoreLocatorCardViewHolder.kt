...
import kotlinx.android.synthetic.main.store_nearby_map_card_item.view.*
import za.co.woolworths.financial.services.android.models.dto.StoreDetails
import za.co.woolworths.financial.services.android.util.WFormatter

class StoreLocatorCardViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
    constructor(parent: ViewGroup) : this(LayoutInflater.from(parent.context).inflate(R.layout.store_nearby_map_card_item, parent, false))
