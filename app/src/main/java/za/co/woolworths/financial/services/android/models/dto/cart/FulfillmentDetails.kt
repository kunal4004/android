...
@Parcelize
data class FulfillmentDetails(val foodMaximumQuantity: Int?, val address: Address?, val fulfillmentStores: @RawValue JsonElement?, val deliveryType: String?, val bulkPromotionEnabled: Boolean?, val deliverable: Boolean?, var storeName: String?, val storeId: String?, val otherMaximumQuantity: Int?, var liquorDeliverable:Boolean): Parcelable
